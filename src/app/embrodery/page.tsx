    ...
    <div style={{ paddingTop: "120px", minHeight: "100vh" }}>
      <div className="container" style={{ maxWidth: "1100px", margin: "0 auto", paddingBottom: "4rem" }}>
        ...
        <section className="slide-up" style={{ animationDelay: "0.25s", marginBottom: "2.5rem" }}>
          ...
          <img src="https://vashishthaluxuryfashion.com/wp-content/uploads/2019/09/TEMP8-scaled.jpg" alt="Hand embroidery archive" style={{ width: "100%", border: "1px solid var(--color-border)", objectFit: "cover", aspectRatio: "16 / 7" }} />
        </section>
